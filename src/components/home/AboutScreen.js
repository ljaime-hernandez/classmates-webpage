...
export const AboutScreen = () => {
  return (
    <div>
        <h1 className='mb-5 mt-5 d-flex justify-content-center'>¿En que creemos?</h1>

          <p className='about__paragraph'>En CLASSMATES creemos en el poder de la educación porque sabemos
        ...
        <h1 className='mb-5 mt-5 d-flex justify-content-center'>¿Quienes somos?</h1>
          ...
          <h1 className='mb-5 mt-5 d-flex justify-content-center'>¿Por que CLASSMATES?</h1>
          <h4 className='mb-5 mt-5 d-flex justify-content-center'>Comodidad:</h4>
          <p className='about__paragraph'>✓ Nuestras tutorías son virtuales, por lo tanto, puedes estudiar
          ...
          en tus sueños.</p>
          <h4 className='mb-5 mt-5 d-flex justify-content-center'>Flexibilidad:</h4>
          <p className='about__paragraph'>✓ Teniendo en cuenta tu disponibilidad, puedes escoger los días y horarios
